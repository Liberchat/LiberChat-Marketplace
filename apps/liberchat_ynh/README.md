...
- Documentation administrateur : <https://github.com/Liberchat/liberchat_ynh>
...
Veuillez envoyer vos pull requests vers la [branche testing](https://github.com/Liberchat/liberchat_ynh/tree/testing).
